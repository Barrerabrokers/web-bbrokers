    ...
    <div className="min-h-screen bg-ink">
      ...
      <main>
        ...
        <section className="relative bg-ink text-bone pt-20 md:pt-24">
          <div className="relative min-h-[520px] h-[66svh] max-h-[720px] overflow-hidden bg-ink-600">
            {primaryImage && (
              <Image
                src={primaryImage}
            ...
            <div className="absolute inset-0 z-10 flex flex-col justify-end pb-5 md:pb-12">
              <div className="container-custom">
                <div className="max-w-4xl rounded-lg border border-[#F1EADE]/20 bg-[#151415]/72 p-4 shadow-2xl backdrop-blur-md md:p-8">
                  <Reveal variant="fade-up" duration={1000}>
                    <Link
                      href="/desarrollos"
                      className="inline-flex items-center gap-2 text-[#F1EADE]/75 hover:text-[#F1EADE] text-[10px] uppercase tracking-widest mb-4 md:text-[11px] md:mb-5"
                    >
                  ...
                  <Reveal variant="fade-up" delay={150} duration={1200}>
                    <div className="flex flex-wrap items-center gap-2 mb-3 md:gap-3 md:mb-4">
                  ...
                  <Reveal variant="clip-up" delay={300} duration={1600}>
                    <h1 className="font-display font-light text-[34px] md:text-[68px] lg:text-[88px] tracking-[-0.03em] leading-[0.92] text-[#F1EADE] drop-shadow-sm">
                      {development.name}
                    </h1>
                  </Reveal>

                  <Reveal variant="fade-up" delay={500} duration={1200}>
                    <div className="flex items-start gap-2 mt-4 text-[#F1EADE]/80 md:mt-5">
          ...
          <div className="container-custom py-6 md:py-8">
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
              ...
              <div className="rounded-lg border border-bone/10 bg-bone/5 p-5">
                ...
                <div className="font-display font-light text-xl md:text-3xl text-bone flex items-center gap-2">
              ...
              {development.brochureUrl && (
                <div className="rounded-lg border border-bone/10 bg-bone/5 p-5 col-span-2 lg:col-span-1">
                  <p className="text-[10px] uppercase tracking-widest text-bone/50 mb-1">
                    Brochure
                  </p>
                  <Link
