    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-8">
        <div className="card p-5">
          ...
          <div className="text-xs text-gray-500 tracking-tight">Nuevos</div>
        </div>
        <div className="card p-5">
          ...
          <div className="text-xs text-gray-500 tracking-tight">Contactados</div>
        </div>
        <div className="card p-5">
          <div className="text-3xl font-semibold tracking-tightest text-gray-50 mb-1">
            {contacts.length}
          </div>
          <div className="text-xs text-gray-500 tracking-tight">Total</div>
        </div>
      </div>
      ...
      <div className="space-y-3">
            ...
            <div className="flex items-start justify-between flex-wrap gap-3 mb-3">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2 flex-wrap">
                  <h3 className="text-base font-semibold tracking-tight text-gray-50">
                    {contact.name}
                  </h3>
                  <span
                ...
                <div className="rounded-md border border-gray-800 bg-gray-900/50 p-3 mt-2">
        ...
        {contacts.length === 0 && (
          <div className="card p-16 text-center">
            <Mail className="h-10 w-10 text-gray-600 mx-auto mb-4" />
